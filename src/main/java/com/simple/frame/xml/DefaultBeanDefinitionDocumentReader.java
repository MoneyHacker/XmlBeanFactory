...
import com.simple.frame.resource.support.ResourcePatternUtils;
...
import com.simple.frame.xml.bean.BeanComponentDefinition;
			...
			if (StringUtils.hasText(profileSpec)) {
				...
				if (!getReaderContext().getEnvironment().acceptsProfiles(specifiedProfiles)) {
					if (log.isInfoEnabled()) {
						log.info("Skipped XML bean definition file due to specified profiles [" + profileSpec +
		...
		if (absoluteLocation) {
			try {
				...
				if (log.isDebugEnabled()) {
					log.debug("Imported " + importCount + " bean definitions from URL location [" + location + "]");
				}
			}
			...
			try {
				...
				if (log.isDebugEnabled()) {
					log.debug("Imported " + importCount + " bean definitions from relative location [" + location + "]");
				}
			}
