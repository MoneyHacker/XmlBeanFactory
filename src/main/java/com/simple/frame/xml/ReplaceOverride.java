...
import com.simple.frame.xml.bean.MethodOverride;
...
public class ReplaceOverride extends MethodOverride {
	...
	public ReplaceOverride(String methodName, String methodReplacerBeanName) {
		super(methodName);
		Objects.requireNonNull(methodName, "Method replacer bean name must not be null");
	...
	public boolean equals(Object other) {
		...
		return (Objects.equals(this.methodReplacerBeanName, that.methodReplacerBeanName) &&
				Objects.equals(this.typeIdentifiers, that.typeIdentifiers));
	}

	@Override
	public int hashCode() {
		int hashCode = super.hashCode();
		hashCode = 29 * hashCode + nullSafeHashCode(this.methodReplacerBeanName);
		hashCode = 29 * hashCode + nullSafeHashCode(this.typeIdentifiers);
		return hashCode;
	}
	/**
