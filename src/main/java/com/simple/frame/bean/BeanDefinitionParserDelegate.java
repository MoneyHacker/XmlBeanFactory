...
import com.simple.frame.bean.override.LookupOverride;
import com.simple.frame.bean.override.ReplaceOverride;
import com.simple.frame.bean.spi.BeanDefinitionParser;
import com.simple.frame.bean.spi.NamespaceHandler;
import com.simple.frame.bean.spi.SourceExtractor;
import com.simple.frame.bean.module.*;
...
import com.simple.frame.bean.spi.BeanDefinitionDecorator;
...
public class BeanDefinitionParserDelegate {
	...
	public BeanDefinitionHolder parseBeanDefinitionElement(Element ele, BeanDefinition containingBean) {
		...
		if (!StringUtils.hasText(beanName) && !aliases.isEmpty()) {
			...
			if (log.isDebugEnabled()) {
				log.debug("No XML 'id' specified - using '" + beanName +
		...
		if (beanDefinition != null) {
			if (!StringUtils.hasText(beanName)) {
				try {
					...
					if (log.isDebugEnabled()) {
						log.debug("Neither XML 'id' nor 'name' specified - " +
	...
	protected void checkNameUniqueness(String beanName, List<String> aliases, Element beanElement) {
		...
		if (foundName == null) {
			foundName = findFirstMatch(this.usedNames, aliases);
		}
		if (foundName != null) {
	...
	private BeanDefinitionHolder parseNestedCustomElement(Element ele, BeanDefinition containingBd) {
		...
		String id = ele.getNodeName() + GENERATED_BEAN_NAME_SEPARATOR +
				ObjectUtils.getIdentityHexString(innerDefinition);
		if (log.isDebugEnabled()) {
			log.debug("Using generated bean name [" + id +
