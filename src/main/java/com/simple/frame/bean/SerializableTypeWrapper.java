...
import com.simple.frame.bean.module.MethodParameter;
import com.simple.frame.resource.util.Assert;
import com.simple.frame.resource.util.ConcurrentReferenceHashMap;
...
public abstract class SerializableTypeWrapper {
	 ...
	 */
	/** @Nullable **/
	public static Type forTypeProvider(final TypeProvider provider) {
